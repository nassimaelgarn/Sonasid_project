...
def main() -> None:
    ...
    ws.append(["abdelkaioume.ammour", "Am1122", "Abdelkaioume Ammour", "ammour@company.com", "analyst", 1])
    ws.append(["adil.jiri", "AdiL1122", "Adil Jiri", "", "analyst", 1])
    ws.append(["nassima.elgarn", "Na1122", "Nassima EL GARN", "nassima.elgarn@uir.ac.ma", "analyst", 1])
