/** Modèles chat — défauts alignés sur backend/llm/model_registry.py */

export const DEFAULT_CHAT_MODEL_OPTIONS = [
  { id: 'kimi', label: 'Kimi K2.6', hint: 'Azure · entreprise', dot: 'bg-rose-500' },
  { id: 'gpt4o', label: 'GPT-4o', hint: 'OpenRouter', dot: 'bg-sky-500' },
  { id: 'gpt41', label: 'GPT-4.1', hint: 'OpenRouter', dot: 'bg-violet-500' },
  { id: 'o3mini', label: 'O3 mini', hint: 'OpenRouter', dot: 'bg-amber-500' },
  { id: 'flash', label: 'Flash', hint: 'Cloud · secours', dot: 'bg-fuchsia-500' },
